...
My_Stringer.drawString("приближением искомой точки x^{*}.",30,925);
        ...
        void nextButton_actionPerformed(ActionEvent e) {
                ...
                if (DrawPanels.cc == DrawPanels.count - 1||DrawPanels.cc ==95) {
                        return;
                }
                if (DrawPanels.ccm == DrawPanels.count - 1||DrawPanels.ccm==95) {
                       return;
               }

                if(DrawPanels.cc==95||DrawPanels.ccm==95)nextButton.setEnabled(false);//34
                if(DrawPanels.cc<94||DrawPanels.ccm<94)nextButton.setEnabled(true);//34
                DrawPanels.cc++;
                DrawPanels.ccm++;
