...
public    Font FontSubTitle= new java.awt.Font("Dialog", 3, 12);
 ...
 // JPanel jPanel1 = new JPanel();//Шрифт
  ...
  Panel_pict jPanel2 = new Panel_pict();
	...
	jLabel1.setText("Сравнение методов Марквардта и Ньютона .");
...
My_Stringer.drawString("приближением искомой точки x^{*}.",30,925);
        ...
        void nextButton_actionPerformed(ActionEvent e) {
                ...
                if (DrawPanels.ccm == DrawPanels.count - 1||DrawPanels.ccm==94) {
                       return;
               }

                if(DrawPanels.cc==100||DrawPanels.ccm==100)nextButton.setEnabled(false);//34
                if(DrawPanels.cc<100||DrawPanels.ccm<100)nextButton.setEnabled(true);//34
                DrawPanels.cc++;
                DrawPanels.ccm++;
