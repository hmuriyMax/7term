...
//static boolean isDouble = false;
       ...
       // public double[] Vektor = {100,  50, 25, 12.5, 6.25,3.125, 1.5625, 0.78125, 0.390625, 0.1953125, 0.09765625, 0.048828125, 0.0244140625, 0.01220703125 , 0.006103515625, 0.0030517578125, 0.00152587890625, 0.000762939453125, 0.0003814697265625, 0.00019073486328125, 0.000095367431640625, 0.0000476837158203125, 0.00002384185791015625, 0.000011920928955078125 ,0.0000059604644775390625, 0.00000298023223876953125 ,0.000001490116119384765625 ,0.0000007450580596923828125, 0.00000037252902984619140625 ,0.000000186264514923095703125 , 0.0000000931322574615478515625};
        ...
        public static QuadFuncs f = new QuadFuncs(1, 0, 1, 0,false);
           public static QuadFuncs f2 = new QuadFuncs(1, 0, 1, 0,true);
         //  public static QuadFuncs_r f4 = new QuadFuncs_r(1, 0, 1, 0, true);
 ...
 public static void moveCenter(int sx, int sy) {
     ...
     public static void moveCenter_2(int sx, int sy) {
            xCen += sx;
            yCen += sy;
            LevelLiness.init(f2, xOff, yOff, xLen, yLen, scale, xCen, yCen,levelLinesColor);
    }
        ...
        public static void setFunc(int v) {
             ...
             //   isDouble = false;
               ...
               //  variant = 0;
                ...
                x1_r[0] = x1s[v];
                x2_r[0] = x2s[v];
                f = new QuadFuncs(aArr[v], bArr[v], cArr[v], dArr[v],false);
                f.setx1x2(x1[0], x2[0]);

                f2 = new  QuadFuncs (aArr[v], bArr[v], cArr[v], dArr[v],true);
                ...
                switch (step) {
                        ...
                        case 1:
                                ...
                                c = "Задаем x^{0} = (" + f.x1Str() + "; " + f.x2Str() + "), \u03b5_{1} = " +
                                        f.eps1Str() + ", \u03b5_{2} = " + f.eps2Str() + "," + " \u03BC^{0} = "+f3.Vektor[k]+"."+//f3.Vektor[k]
                        ...
                        case 4:
                           ...
                           cm += "Вычислим градиент в точке x^{" + k + "''}: \u2207f(x^{" + k +//r{}n{}
                                ...
                                if(done2 || k == 0) break;
                              c += "r{}n{}Вычислим градиент в точке x^{" + k + "'}: \u2207f(x^{" + k +//r{}n{}
                                      "}) = #{" + f2.g1Str() + "}{" +
                                      f2.g2Str() + "}e{}";
                        ...
                        case 5:
                                ...
                                if(k != 0) c += "R{}";
                                c +=
                                        "Проверим выполнение критерия окончания \u2225\u2207f(x^{" +
                                        k + "})\u2225 \u2264 \u03b5_{1}:n{}";
                                ...
                                if (f.gNorm() <= f.eps1) {
                                        c += f.gNormStr() + " \u2264 " + f.eps1Str() +
                                           ...
                                           // done1 = false;
                                          //  if (steps[cc].equals("5.11")||cc>=43){ nextStep = 12;}
                                        //nextStep = -1;
                                }
                                else {
                                        c += f.gNormStr() + " > " + f.eps1Str() +
                                ...
                                if(done2 || k == 0) break;
                                c +=
                                        "r{}n{}Проверим выполнение критерия окончания: \u2225\u2207f(x^{" +
                                        k + "'})\u2225 \u2264 \u03b5_{1}:n{} ";
                           ...
                           if(done3 || k == 0) break;
                           cm+=
                               "  Проверим выполнение критерия окончания \u2225\u2207f(x^{" + k + "})\u2225 \u2264 \u03b5_{1}:n{}"+
                                 "\u2225\u2207f(x^{" + k + "})\u2225 :n{}";
                          ...
                          if (f3.gNorm() <= f3.eps1)
                           {
                             cm+=f3.gNormStr() + "\u2264 " + f3.eps1Str() +
                                               ", условие выполняется, значит x^{***} = x^{" + (k) +
                                                "''} = "+"#{"+ f3. x1NewStr()+"}{"+f3. x2NewStr()+"}"+ " - искомое n{}приближение.";
                               done3 = true;
                               // nextStep = -1;
                        ...
                        case 6:
                                ...
                                nextStep = step + 1;
                                // if(step==6)
                                // { cm+="Вычисляем матрицу H(x^{" + k + "''})+\u03BC^{"+ k +"}*E = " + f3.h_plusStr(k) + "e{}";}
                                 if(done3 || k == 0) break;
                                 cm+="Вычисляем матрицу H(x^{" + k + "''}) = " + f3.hStr() + "n{}"+
                                  "n{}Вычисляем матрицу H(x^{" + k + "''})+\u03BC^{"+ k +"}*E = " + f3.h_plusStr(k);
                               if(done2 || k == 0) break;
                                c += "r{}n{}Вычисляем матрицу H(x^{" + k + "'}) = " + f2.hStr() + "e{}";
                        ...
                        case 7:
                               ...
                               //        "''})+\u03BC^{"+ k +"}*E]^{-1}= " + f3.h_1_plusStr(k) + "e{}";}
                                ...
                                if(done3 || k == 0) break;
                                cm += "n{}Вычисляем значение обратной матрицы: [H(x^{" + k +
                                       "''})+\u03BC^{"+ k +"}*E]^{-1}= " + f3.h_1_plusStr(k) + "e{}";

                               // if(done2 || k == 0) break;
                                c += "r{}n{}Вычисляем значение обратной матрицы: H^{-1}(x^{" + k +
                                        "'}) = " + f2.h_1Str() + "e{}";
                        ...
                        case 8:
                                ...
                                if (!done3) {
                                  cm+= "Вычисляем"+
                                   ...
                                   f3.g1Str() + "}{" + f3.g2Str() + "} = " + "#{" + f3.d1Str() + "}{" + f3.d2Str() + "}";
                                  }
                        ...
                        case 9:
                                ...
                                if (!done2) {
                                        c += "r{}n{}Находим точку x^{" + (k + 1) + "'} = x^{" + k +
                                                ...
                                                f2.stepStr() +
                                                " #{" + f2.d1Str() + "}{" + f2.d2Str() + "} = " +
                                                "#{" + f2.x1NewStr() + "}{" + f2.x2NewStr() + "}e{}";
                                }
                                //k++;
                                 if (!done3) {
                                  cm = "  Находим точку x^{" + (k + 1) + "''} = x^{" + k + "''} + d^{" +
                              k + "} = " +
                             "#{" + f3.x1Str() + "}{" + f3.x2Str() + "} + #{" + f3.d1Str() + "}{" + f3.d2Str() + "} = " +
                             "#{"+ f3. x1NewStr()+"}{"+f3. x2NewStr()+"}";
                   ...
                   cm+= "f(x^{" + (k + 1) + "''}) = " + f3.dFuncNormStr_a() + " < "+ f3.dFuncNormStr_b() + " = f(x^{" + k + "''}) "+".n{}"+
                    ...
                    " n{}и переходим к шагу 4.";
                     f3.setx1x2(f3.x1New(k), f3.x1New(k));
                    //done3 = true;
                    nextStep = step + 1;
                        ...
                        case 11:
                               ...
                               int kkk = k;
                                ...
                                if (f.dFuncNorm() < f.eps2) {
                                     ...
                                     if (steps[cc].equals("5.11")||cc==43){ nextStep =-1;}
                                   }
                                 else {
                                         c += f.dFuncNormStr() + " > " + f.eps2Str() +
                                ...
                                if (f2.dFuncNorm() < f2.eps2) {
                                        c += f2.dFuncNormStr() + " < " + f2.eps2Str() +",условие выполняется,значит n{}x^{*} = x_{" +
                                                (k + 1) +"} = #{" + f2.x1NewStr() + "}{" + f2.x2NewStr() +"}- искомое приближение к решению.";
                                        done2 = true;
                                          //nextStep = -1;
                                }
                                else {
                                        c += f2.dFuncNormStr() + " > " + f2.eps2Str() +
                                                ", n{}условия не выполняются, положим k = " + (kk + 1) +
                                                " и переходим к шагу 4.";
                                }
                                if(!done2)   { f2.setx1x2(f2.x1New(), f2.x2New());
                                k=kk+1;
                                }

                   if(done3) break;
                   cm+= " Проверяем выполнение условия f(x^{" + (kkk + 1) + "''}) < f(x^{" + kkk + "''}): n{}";
                 if (f3.dFuncNorm_a() < f3.dFuncNorm_b())
              {  //cm+= " Проверяем выполнение условия f(x^{" + (kkk + 1) + "''}) < f(x^{" + kkk + "''}): n{}";
                 cm+= "f(x^{" + (kkk + 1) + "''}) = " + f3.dFuncNormStr_a() + " < "+ f3.dFuncNormStr_b() + " = f(x^{" + kkk + "''}) "+".n{}"+
                   " Условия выполняется, поэтому полагаем k = k+1 = "+kkk+"+1 = "+(kkk+1)+" ,n{}\u03BC^{"+(kkk+1)+"} = \u03BC^{"+kkk+"}/2 = "+f3.Vektor[kkk]/2 +
                   " и переходим к шагу 4.";
                   ...
                   cm+= " f(x^{" + (kkk + 1) + "''}) = " +f3.dFuncNormStr_a() + " > "+ f3.dFuncNormStr_b() + " = f(x^{" + kkk + "''})"+".n{}" +
                  " Условия не выполняется, поэтому полагаем n{}\u03BC^{"+kkk+"} = 2 * \u03BC^{"+kkk+"} = 2 * "+f3.Vektor[kkk]/2 +" = "+(2*f3.Vektor[kkk]/2)+
                   " n{}и переходим к шагу 6.";
                     nextStep = 6;
                      k=kkk;
                    nextStep = -1;
                      ...
                      break;
                       case 12:
                             //   c = "Приближение, найденное методом Ньютона, находится n{}на расстоянии"+
                               //         f.normalize(1.145) + " от точного минимума.n{}";
                              //  c += "r{}n{}Приближение, найденное методом Ньютона-Рафсона, находится n{}на расстоянии "+
                              //          f.normalize(0.015) + " от точного минимума.e{}n{}";
                                nextStep = -1;
                               // if (nextStep ==-1){}
                                break;
// nextStep = -1;
...
/////////////////////////////////reshenie
                g.setColor(ColorSolutionText);
tt = 310;
if(step==1 || step==5 || step==10 || step==11) tt=310;
if(step==2 || step==3  || step==4  || step==6 || step==7 || step==8 || step==9) tt=320;
Stringers.drawString(ss, 50, tt);//55
   if(cc>=44&&k>5){
     cs[cc]="";
     Stringers.drawString(cs[cc], 50, tt);}

   if(cc==43&&k==5)
  { String q;
    q= "    Проверим выполнение критерия окончания \u2225\u2207f(x^{" + k + "})\u2225 \u2264 \u03b5_{1}:n{}"+
                                       f.gNormStr() + " \u2264 " + f.eps1Str() +
                                         ", условие выполняется, значит r{}x^{*} = x^{" + (k + 1) +
                                         "} = #{" + f.x1Str() + "}{" + f.x2Str() +
                                         "}e{} - искомое приближение.";
       g2d.setColor(Color.red);
        Stringers.drawString(q, 50, tt);
  }
  // if(cc>93)    {
    // ss="";
    // Stringers.drawString(ss, 50, tt); }
 //if (steps[cc].equals("5.11")||cc>43){;}

                tt_1 = 408;
                if(step==1  || step==10 ||step==5||step==11) tt_1=408;
               ...
               /* if(ss2 != null) {
                        g.setColor(ColorSolutionText);
                        Stringers.drawString(ss2, 50, 520);//388
                        g2d.setFont(FontSubTitle);
                        g2d.setColor(ColorSubTitle);
                }
                else if(cc>=21){
                       // g.setColor(ColorSolutionText);
                       // Stringers.drawString("Приближение к решению x^{**} = x^{2'} = (0,003; 0,015)^{T} найдено n{}за 2 итерации.", 50 , 540);
                }*/
                g2d.setColor(ColorSolutionNumber);
                g2d.setFont(FontSolutionNumber);
                if(!steps[cc].equals("3.12"))
                     {
                      if(step==1 || step==5 || step==10 || step==11 || step==12) g2d.drawString(steps[cc], 10, 310);
                       else {
                             g2d.drawString(steps[cc], 10, 320);
                             }
                   ...
                   /*if(ss2 != null)
                       {
                        if (!steps[cc].equals("3.12")){
                         if(step== 8 || step==10 || step==11 || step==5 ||(step==6 && k==2) || step==12) g2d.drawString(steps[cc], 10, 540);//408
                         if(step== 9 ||step==4 ||step==6 || step==7) g2d.drawString(steps[cc], 10, 550);//419
                ...
                if(step != 0) {
                  for (int i = 0; i < nPoints; ++i) {
                        LevelLiness.drawLevelLine(x1[i], x2[i]);
                         LevelLines_prN.drawLevelLine_m(x1_r[i], x2_r[i]);
                       // LevelLines_r.drawLevelLine_r(x1_r[i], x2_r[i]);
                     ...
                     if(i>0)
                    {
                     ...
                     g2d.drawLine(x, y, x_1, y_1);
                      ...
                      y_1 = y;
                        ...
                        Stringers.drawString("x^{" + i + "''}", x+8, y - 3);
                        if (cc == count - 1) {
                           Stringers.drawString("x^{***}=", x-20, y-3);
                       }
////////////////////////////////////////////////////////////////////////////////////////////////////
                       // for (int i = 0; i < totalPoints; ++i) {
                       /*     g2d.setColor(i == totalPoints - 1 ? Color.magenta : Color.magenta);
                               int  x_r = xOff + xCen + (int) (scale * x1_r[i]);
                               int   y_r = yOff + yCen - (int) (scale * x2_r[i]);
                                if(i>0)
                           {
                                int xLast2 = xOff + xCen + (int) (scale * x1_r[i-1]);
                                int yLast2 = yOff + yCen - (int) (scale * x2_r[i-1]);
                             ...
                             Stringers.drawString("x^{"+i+"'}", x_r-20 , y_r-3);
                             if (cc == count - 1) {
