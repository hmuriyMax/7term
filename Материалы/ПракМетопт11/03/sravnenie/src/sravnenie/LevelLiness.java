...
public class LevelLiness {
        private static FunctionContainers fc;
        ...
        public static void init(FunctionContainers fc_, int xOff_, int yOff_, int width_, int height_, double scale_,
