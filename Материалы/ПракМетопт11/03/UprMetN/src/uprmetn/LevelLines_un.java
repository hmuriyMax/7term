...
public class LevelLines_un {
        private static FunctionContainer_un fc;
        ...
        public static void init(FunctionContainer_un fc_, int xOff_, int yOff_, int width_, int height_, double scale_,
        ...
        public static void drawLevelLineScreen(double x1, double x2) {
                drawLevelLine((x1 - xOff - xCen) / scale, -(x2 - yOff - yCen) / scale);
        }
